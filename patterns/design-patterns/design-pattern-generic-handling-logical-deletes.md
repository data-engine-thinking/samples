---
uid: design-pattern-generic-handling-logical-deletes
---

# Design Pattern - Generic - Handling Logical Deletes

## Purpose
This Design Pattern standardizes the way that physical deletes from source systems are handled in the Data Warehouse. A *physical* delete in the operational system should lead to a *logical* delete in the Data Warehouse.
...
DWH Key | Logical Key | Name | Color| Current |Deleted | Effective Date | Expiry Date
---|---|---|---|---|---|---|---
...
* If you have a Change Data Capture based source the attribute comparison may potentially be skipped because the CDC mechanisms inform the system whether the record in the Landing Area is new, updated or deleted.
