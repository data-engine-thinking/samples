...
The data logistics process can be described as an 'insert only' set of the unique combination of Data Solution keys. Depending on the type of source table, the process will do the following:
