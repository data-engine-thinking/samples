---
title: "Solution Pattern - SQL Server Family - CDC and Replication"
---
...
```sql file=<rootDir>/patterns/solution-patterns/solution-pattern-sql-server-family-cdc-and-replication-snippet-1.sql
```
