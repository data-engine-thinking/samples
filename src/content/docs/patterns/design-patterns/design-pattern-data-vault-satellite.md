---
title: "Design Pattern - Data Vault - Satellite"
---
...
* The Integration Area into the Derived Integration Area.

Derived Integration Area Satellites may add business logic, but follow the same structural approach.
...
* Multiple passes of the same source table or file may be required: first to insert new keys in the Hub/Link, then to populate Satellites.
...
* Business logic in Derived Integration Area Satellites should not alter raw history; keep transformations transparent and auditable.
